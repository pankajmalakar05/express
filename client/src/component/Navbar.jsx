...
const Navbar = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      {/* TOP BAR */}
      <div className="bg-[#140826] text-white text-sm">
        <div className="max-w-7xl mx-auto px-4 py-2 flex justify-between flex-wrap gap-3">
          <span className="flex items-center gap-2">
            ...
            Unit No. 305, Kalkaji, New Delhi -19
          </span>
      ...
      <nav className="bg-white shadow-lg">
        <div className="max-w-7xl mx-auto px-4 h-24 flex items-center justify-between">
          ...
          {/* DESKTOP MENU */}
          <ul className="hidden md:flex items-center gap-10 font-semibold text-[#140826]">
            <Link
              className="nav-link"
              to="/"
          ...
          <button
            ...
            className="md:hidden text-[#b21f2d]"
          >
            <IoMdMenu size={30} />
          </button>
        </div>
